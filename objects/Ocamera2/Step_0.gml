...
var target_angle = -Ovuilniswagen2.direction + 90;

// Offset in rijrichting (camera kijkt vooruit)
var offset_dist = 150;
var offset_dir = Ovuilniswagen2.direction;

var offset_x = lengthdir_x(offset_dist, offset_dir);
var offset_y = lengthdir_y(offset_dist, offset_dir);

// Doelwaarden
var target_x = Ovuilniswagen2.x + offset_x - camera_get_view_width(cam) / 2;
var target_y = Ovuilniswagen2.y + offset_y - camera_get_view_height(cam) / 2;
